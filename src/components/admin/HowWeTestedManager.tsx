...
const DEFAULT_AUDIO_TEMPLATE: HowWeTestedData = {
  ...
  performance_observations: 'The Sony WH-1000XM5 delivered the highest low-frequency attenuation (94.2% reduction in engine drone), while the Bose QuietComfort Ultra scored highest in ergonomic comfort for eyeglasses wearers with zero ear-cup pressure fatigue after 8 continuous hours.',
