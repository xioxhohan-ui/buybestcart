  ...
  return (
    ...
    >
      ...
      <div className="product-card-body">
        ...
        {/* Action Row */}
        <div className="product-card-price-row" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginTop: 'auto', paddingTop: '0.5rem' }}>
          <span
            style={{
              fontSize: '0.75rem',
          ...
          >
            ● {formatAvailability(product.availability || 'In Stock')}
          </span>
          <Link href={`/products/${product.slug}`} className="btn btn-secondary btn-sm" style={{ padding: '0.3rem 0.7rem', fontSize: '0.75rem' }}>
            Full Review ↗
          </Link>
        </div>
