...
import AnimatedCatalogTabs from '@/components/home/AnimatedCatalogTabs';
...
export default async function HomePage() {
  ...
  return (
    <div>
      ...
      {/* 03. CMS-DRIVEN RUNNING MARQUEE TICKER */}
      ...
      {/* 04. EDITORIAL CREDIBILITY & LAB TESTING STATS */}
      <AnimatedStats />
      ...
      {/* 06. HIGH-VELOCITY TRENDING PICKS */}
      <TrendingProductsSection products={(featuredProducts as Product[]) || []} />
      ...
      {/* 10. CURATED HUBS & CATEGORY TILES */}
      <CategoryShowcaseGrid categories={(categories as Category[]) || []} />
      ...
      {/* 13. WEEKLY EDITORIAL NEWSLETTER */}
      <NewsletterSection />
