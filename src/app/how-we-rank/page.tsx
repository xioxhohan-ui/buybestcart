...
export const metadata: Metadata = {
  title: 'Testing Standards & Review Methodology | Buy Best Cart',
  description: 'Learn how Buy Best Cart produces 100% unbiased hardware reviews, acoustic benchmarks, and verified Amazon product recommendations.',
  ...
  alternates: {
    canonical: `${SITE_URL}/how-we-rank`,
  },
  openGraph: {
    title: 'Testing Standards & Review Methodology | Buy Best Cart',
    description: 'Learn how Buy Best Cart produces 100% unbiased hardware reviews, acoustic benchmarks, and verified Amazon product recommendations.',
    url: `${SITE_URL}/how-we-rank`,
    siteName: 'Buy Best Cart',
    type: 'website',
    images: [{ url: `${SITE_URL}/og-image.png`, width: 1200, height: 630, alt: 'Buy Best Cart Ranking Standards' }],
  },
  twitter: {
  ...
  return (
    <div className="container" style={{ paddingTop: '1.5rem', paddingBottom: '4rem', maxWidth: '840px' }}>
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: '2rem', fontSize: '1.0625rem', lineHeight: 1.8, color: 'var(--text-secondary)' }}>
        ...
        <section>
          <h2 style={{ color: 'var(--text-primary)', marginBottom: '0.75rem' }}>4. Ongoing Product Testing &amp; Availability Monitoring</h2>
          <p>
            We regularly update our guides to reflect verified merchant inventory and new hardware releases. Merchant terms, checkout prices, and stock levels are controlled exclusively on Amazon.
          </p>
        </section>
