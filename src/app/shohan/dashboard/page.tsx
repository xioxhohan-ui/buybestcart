...
export default async function AdminDashboardPage() {
  ...
  return (
    <div>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'minmax(400px, 1.4fr) minmax(300px, 1fr)', gap: '2rem' }}>
        {/* Top Products */}
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '0.75rem' }}>
            <div style={{ background: '#FAF9F6', border: '1px solid var(--border)', borderRadius: 'var(--radius-sm)', padding: '1rem' }}>
              ...
              <p style={{ fontSize: '0.75rem', color: 'var(--text-secondary)', lineHeight: 1.5, margin: 0 }}>
                Updating a product in `/shohan/products` immediately cascades to homepage cards, category grids, comparisons, and buying guides without duplicate entry.
              </p>
            </div>
