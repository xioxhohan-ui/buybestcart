...
export default async function AdminAnalyticsPage() {
  ...
  return (
    <div>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(min(100%, 360px), 1fr))', gap: '2rem', marginBottom: '2.5rem' }}>
        ...
        <div style={{ background: 'var(--bg-surface)', border: '1px solid var(--border)', borderRadius: 'var(--radius-lg)', padding: '1.5rem', boxShadow: 'var(--shadow-sm)' }}>
          ...
          <div className="admin-table-wrapper">
            <table className="editorial-table" style={{ width: '100%', minWidth: '380px' }}>
              <thead>
                <tr>
                  <th>ASIN / Item</th>
                  <th>Region</th>
        ...
        <div style={{ background: 'var(--bg-surface)', border: '1px solid var(--border)', borderRadius: 'var(--radius-lg)', padding: '1.5rem', boxShadow: 'var(--shadow-sm)' }}>
          ...
          <div className="admin-table-wrapper">
            <table className="editorial-table" style={{ width: '100%', minWidth: '340px' }}>
              <thead>
                <tr>
                  <th>Search Query</th>
                  <th>Results Found</th>
