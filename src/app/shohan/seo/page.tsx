...
export default function AdminSEOPage() {
  const [templates, setTemplates] = useState({
    default_title: 'Buy Best Cart — The Independent Guide to Better Tech & Lifestyle Products',
    ...
    homepage_title: 'Buy Best Cart — Honest Reviews, Buying Guides & Product Rankings',
    ...
    product_template: '{product_name} — Price, Reviews & Best Alternatives | Buy Best Cart',
    category_template: 'Best {category} — Top Picks & Buying Guide | Buy Best Cart',
    brand_template: '{brand_name} Products, Ratings & Reviews | Buy Best Cart',
    article_template: '{article_title} | Buy Best Cart Editorial',
    review_template: '{product_name} Review — Pros, Cons & Verdict | Buy Best Cart',
    guide_template: 'The Definitive {category} Buying Guide ({year}) | Buy Best Cart',
    comparison_template: '{product_a} vs {product_b} — Head-to-Head Showdown | Buy Best Cart',
